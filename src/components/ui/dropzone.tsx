    ...
    <div className="space-y-2">
      <div
        ...
        className={cn(
          ...
          isDragActive ? 'border-blue-400 bg-blue-950/30' : 'border-gray-700 hover:border-gray-500 bg-gray-900/50',
      ...
      >
        ...
        {activeFile ? (
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm font-medium text-gray-200">{activeFile.name}</p>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-200">{isDragActive ? 'Drop file here' : label}</p>
